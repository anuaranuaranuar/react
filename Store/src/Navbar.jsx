  ...
  <header className='flex border-b py-4 px-4 sm:px-10 bg-white font-sans min-h-[70px] tracking-wide relative z-50'>
    <div className='flex flex-wrap items-center gap-4 w-full'>
        ...
        <div className='lg:!flex lg:flex-auto max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
          ...
          <ul className='lg:flex lg:gap-x-8 max-lg:space-y-2'>
            ...
            <li className='max-lg:border-b max-lg:py-3'>
              <a href='#' className='hover:text-primary text-gray-600 block font-bold text-[15px] duration-300'>Home</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3'><a href='#' className='hover:text-primary text-gray-600 block font-bold text-[15px] duration-300'>Shop</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3'><a href='#' className='hover:text-primary text-gray-600 block font-bold text-[15px] duration-300'>Sale</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3'><a href='#' className='hover:text-primary text-gray-600 block font-bold text-[15px] duration-300'>Manage</a>
            </li>
          </ul>
          ...
          <ul className='lg:flex lg:items-center ml-auto max-lg:block lg:space-x-8 '>
            <li className='max-lg:border-b max-lg:py-3 max-lg:mt-2'>
              <a href='#' className='hover:text-primary text-gray-600 block font-bold text-[15px] duration-300'>Pricing</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 max-lg:mt-2'><a href='#' className='hover:text-primary text-gray-600 block font-bold text-[15px] duration-300'>Learn</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className='flex items-center ml-auto space-x-6'>
        <a href='#' className='hover:text-primary text-gray-600 block font-bold text-[15px]'>Log in</a>
        <button className='px-4 py-2.5 text-sm rounded font-bold text-secondary border-2 border-[#1d294f] bg-primary transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#1d294f]'>Start free trial</button>
